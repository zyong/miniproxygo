...
var (
	ErrInvalidUnreadByte = errors.New("m_bufio: invalid use of UnreadByte")
	ErrInvalidUnreadRune = errors.New("m_bufio: invalid use of UnreadRune")
	ErrBufferFull        = errors.New("m_bufio: buffer full")
	ErrNegativeCount     = errors.New("m_bufio: negative count")
)
